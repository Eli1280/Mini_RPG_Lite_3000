...
import algo.rpg.hero.Healer;
import algo.rpg.hero.Hunter;
import algo.rpg.hero.Mage;
import algo.rpg.hero.Warrior;
...
public class Selectionneur implements Initializable
{
    @FXML
    ...
    public void onFightButtonClick() throws IOException {
        ...
        {
            FXMLLoader fxmlLoader = new FXMLLoader(MainApplication.class.getResource("gameview.fxml"));
